...
public class Interfata extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem6.setText("Add people...");
        jMenu2.add(jMenuItem6);

        jMenuItem7.setText("Add activity...");
        ...
        jMenu1.setText("Look at...");

        jMenuItem4.setText("Current user");
        jMenu1.add(jMenuItem4);

        jMenuItem3.setText("People");
        jMenu1.add(jMenuItem3);

        jMenuItem5.setText("Activities");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        p = jPasswordField1.getSelectedText();
        if (u.equals(a.getUser().getUsername()) && p.equals(a.getUser().getParola())) 
        {
